...
if __name__ == '__main__':
    ...
    train_nn, label_train_nn = dataset.get_chunk(number_of_input_pic)
    ...
    with tf.Session() as sess:
        network = net.network_one_convolution(shape_of_kernel= (28,28), nr_training_itaration= 2000, stride=28 )
