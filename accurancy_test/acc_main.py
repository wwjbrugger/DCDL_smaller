...
if __name__ == '__main__':
    ...
    if SLS_Training:
        first.train_model(network, dithering_used, one_against_all, number_classes_to_predict = number_classes_to_predict, data_set_to_use=data_set_to_use
                      )
    ...
    third.SLS_Conv_2(Number_of_disjuntion_term_in_SLS, Maximum_Steps_in_SKS,stride_of_convolution, SLS_Training, use_prediction)
