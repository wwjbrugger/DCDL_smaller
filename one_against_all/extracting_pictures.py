...
if __name__ == '__main__':
    ...
    help.visualize_singel_kernel(kernel, 28, "Kernel for 1 againt all")
    ...
    for i, formel in enumerate(kernel_approximation):
        ...
        formel.built_plot(0, '1 Visualisierung von extrahierter Regel {} '.format(i))
